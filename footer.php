 ...
 */
?>	
<?php if(function_exists('zerif_before_footer_trigger')) { zerif_before_footer_trigger(); } ?>
...
<div class="container">
	<?php if(function_exists('zerif_top_footer_trigger')) { zerif_top_footer_trigger(); } ?>
	...
	<?php
		...
		if( !empty($footer_class) ) {
			...
			echo '</div>';
			?>
	<?php if(function_exists('zerif_bottom_footer_trigger')) { zerif_bottom_footer_trigger(); } ?>
</div> <!-- / END CONTAINER -->

</footer> <!-- / END FOOOTER  -->

<?php if(function_exists('zerif_after_footer_trigger')) { zerif_after_footer_trigger(); } ?>
...
if( !empty($minimalzerif_parent_theme) && ($minimalzerif_parent_theme == 'zerif-pro') ) {
	...
	if(function_exists('zerif_bottom_body_trigger')) { zerif_bottom_body_trigger(); }
?>
